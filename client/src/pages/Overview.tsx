...
export default function Overview() {
  ...
  const { data: atRiskClientsData, isLoading: clientsLoading } = useQuery<
    AtRiskClient[]
  >({
  ...
  const { data: benchmarkingData, isLoading: benchmarkingLoading } = useQuery<
    BenchmarkData[]
  >({
    ...
    >
      ...
      >
        ...
        <p className="text-muted-foreground">
          Monitor client sentiment and churn risk across your portfolio
        </p>
      </motion.div>
      ...
      >
        ...
        <MetricCard
          ...
          change={-12}
          trend={
            metrics?.atRiskClients && metrics.atRiskClients > 3 ? "up" : "down"
          }
        ...
        <MetricCard
          ...
          change={-8}
          trend={
            metrics?.avgRiskScore && metrics.avgRiskScore > 75 ? "up" : "down"
          }
      ...
      >
        ...
        >
          <ClientBenchmarking
            ...
            isLoading={benchmarkingChartsLoading}
          />
        </motion.div>
      </motion.div>
    </motion.div>
