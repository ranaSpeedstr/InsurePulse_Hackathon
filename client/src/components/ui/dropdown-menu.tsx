...
import { dropdownVariants, iconVariants, animationUtils } from "@/lib/animations"
  ...
  return (
    ...
    >
      <motion.div
        ...
        animate="visible"
        whileHover="hover"
        transition={animationUtils.getReducedMotionConfig(prefersReducedMotion).transition}
      >
        {props.children}
      </motion.div>
    </DropdownMenuPrimitive.Item>
